...
def test_query_scalability():
    ...
    status = "✅ PASS" if max_percent_increase < 50 else "⚠️ WARNING" if max_percent_increase < 100 else "❌ FAIL"
...
def generate_report(results):
        ...
        "requirement_11_performance": {
            "query_performance": {
                ...
                "scalability": {
                    ...
                    "status": "✅ GOOD" if results['scalability']['reasonable_scaling'] else "⚠️ WARNING"
                }
            },
            "memory_usage": {
    ...
    if score >= 90:
        ...
        print("   Grade: ⚠️  GOOD - Minor improvements needed")
    else:
